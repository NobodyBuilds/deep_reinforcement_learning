...
extern "C" void ui_draw() {
    ...
    ImGui::Spacing();
    ImGui::Text("Gen: %d  rollout gen %d  buffer %d / %d  time:%f", settings.gen,settings.rolloutstep,settings.step * settings.cars,settings.replaybuffersize,settings.rollout_time);
